...
package com.liang.rxjava3.validators;
...
import com.liang.rxjava3.validators.BaseTypeParser.RxMethod;
...
public class JavadocWording {
    ...
    public void maybeDocRefersToMaybeTypes() throws Exception {
        ...
        for (RxMethod m : list) {
            ...
            if (m.javadoc != null) {
                ...
                aOrAn(e, m, "Maybe");
                missingClosingDD(e, m, "Maybe", "com.liang.rxjava3.core");
    ...
    public void flowableDocRefersToFlowableTypes() throws Exception {
        ...
        for (RxMethod m : list) {
            ...
            if (m.javadoc != null) {
                ...
                aOrAn(e, m, "Flowable");
                missingClosingDD(e, m, "Flowable", "com.liang.rxjava3.core");
    ...
    public void parallelFlowableDocRefersToCorrectTypes() throws Exception {
        List<RxMethod> list = BaseTypeParser.parse(TestHelper.findSource("ParallelFlowable", "com.liang.rxjava3.parallel"), "ParallelFlowable");
        ...
        for (RxMethod m : list) {
            ...
            if (m.javadoc != null) {
                ...
                missingClosingDD(e, m, "ParallelFlowable", "com.liang.rxjava3.parallel");
    ...
    public void observableDocRefersToObservableTypes() throws Exception {
        ...
        for (RxMethod m : list) {
            ...
            if (m.javadoc != null) {
                ...
                missingClosingDD(e, m, "Observable", "com.liang.rxjava3.core");
    ...
    public void singleDocRefersToSingleTypes() throws Exception {
        ...
        for (RxMethod m : list) {
            ...
            if (m.javadoc != null) {
                ...
                aOrAn(e, m, "Single");
                missingClosingDD(e, m, "Single", "com.liang.rxjava3.core");
    ...
    public void completableDocRefersToCompletableTypes() throws Exception {
        ...
        for (RxMethod m : list) {
            ...
            if (m.javadoc != null) {
                ...
                missingClosingDD(e, m, "Completable", "com.liang.rxjava3.core");
