...
public class JavadocCodesAndLinks {
    ...
    public void checkFlowable() throws Exception {
        checkSource("Flowable", "com.liang.rxjava3.core");
    }

    @Test
    public void checkCompletable() throws Exception {
        checkSource("Completable", "com.liang.rxjava3.core");
    }

    @Test
    public void checkSingle() throws Exception {
        checkSource("Single", "com.liang.rxjava3.core");
    }

    @Test
    public void checkMaybe() throws Exception {
        checkSource("Maybe", "com.liang.rxjava3.core");
    }

    @Test
    public void checkObservable() throws Exception {
        checkSource("Observable", "com.liang.rxjava3.core");
    }

    @Test
    public void checkParallelFlowable() throws Exception {
        checkSource("ParallelFlowable", "com.liang.rxjava3.parallel");
    }

    @Test
    public void checkCompositeDisposable() throws Exception {
        checkSource("CompositeDisposable", "com.liang.rxjava3.disposables");
    }

    @Test
    public void checkConnectableFlowable() throws Exception {
        checkSource("ConnectableFlowable", "com.liang.rxjava3.flowables");
    }

    @Test
    public void checkConnectableObservable() throws Exception {
        checkSource("ConnectableObservable", "com.liang.rxjava3.observables");
    }

    @Test
    public void checkSchedulers() throws Exception {
        checkSource("Schedulers", "com.liang.rxjava3.schedulers");
    }
