...
import com.liang.rxjava3.internal.operators.flowable.FlowableZipTest.ArgsToString;
...
public class FlowableCombineLatestTest extends RxJavaTest {
    ...
    public void combineLatestNArguments() throws Exception {
        ...
        for (int i = 2; i < 10; i++) {
            ...
            types[i] = i == 2 ? BiFunction.class : Class.forName("com.liang.rxjava3.functions.Function" + i);
