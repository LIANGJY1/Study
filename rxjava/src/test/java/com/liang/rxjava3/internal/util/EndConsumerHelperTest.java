...
import com.liang.rxjava3.exceptions.ProtocolViolationException;
...
public class EndConsumerHelperTest extends RxJavaTest {
    ...
    public void checkDoubleDefaultSubscriberNonAnonymous() {
        ...
        assertEquals(EndConsumerHelper.composeMessage("com.liang.rxjava3.internal.util.EndConsumerHelperTest$EndDefaultSubscriber"), errors.get(0).getMessage());
        assertEquals(errors.toString(), 1, errors.size());
    }
