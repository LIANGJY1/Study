...
public class CompositeExceptionTest extends RxJavaTest {
    ...
    public void exceptionOverview() {
        ...
        assertTrue(overview, overview.contains("com.liang.rxjava3.exceptions.TestException: ex1"));
        assertTrue(overview, overview.contains("com.liang.rxjava3.exceptions.TestException: ex2"));
        assertTrue(overview, overview.contains("com.liang.rxjava3.exceptions.TestException: ex3"));
        assertTrue(overview, overview.contains("com.liang.rxjava3.exceptions.TestException: ex4"));
        assertTrue(overview, overview.contains("at com.liang.rxjava3.exceptions.CompositeExceptionTest.exceptionOverview"));
    }
    ...
    public void causeWithExceptionWithoutStacktrace() {
        ...
        assertTrue(overview, overview.contains("com.liang.rxjava3.exceptions.TestException: ex1"));
        assertTrue(overview, overview.contains("com.liang.rxjava3.exceptions.CompositeException.ExceptionOverview: example"));
    ...
    public void reoccurringException() {
        ...
        assertTrue(overview, overview.contains("Multiple exceptions (2)"));
        assertTrue(overview, overview.contains("com.liang.rxjava3.exceptions.TestException: ex0"));
        assertTrue(overview, overview.contains("com.liang.rxjava3.exceptions.TestException: ex1"));
        assertTrue(overview, overview.contains("com.liang.rxjava3.exceptions.TestException: ex2"));
        assertTrue(overview, overview.contains("(cause not expanded again) com.liang.rxjava3.exceptions.TestException: ex0"));
