...
import com.liang.rxjava3.internal.schedulers.*;
...
public final class Schedulers {
     ...
     * <p>
     * This type of scheduler is less sensitive to leaking {@link com.liang.rxjava3.core.Scheduler.Worker} instances, although
     ...
     * {@link RxJavaPlugins#setInitComputationSchedulerHandler(com.liang.rxjava3.functions.Function)} plugin method.
     ...
     * via the {@link RxJavaPlugins#setComputationSchedulerHandler(com.liang.rxjava3.functions.Function)} method.
     * <p>
     ...
     * &#64;{@link com.liang.rxjava3.annotations.SchedulerSupport SchedulerSupport}({@link com.liang.rxjava3.annotations.SchedulerSupport#COMPUTATION COMPUTATION})
     * annotation.
     ...
     * returned by {@link com.liang.rxjava3.core.Scheduler#createWorker()} but otherwise will start a new backing
     ...
     * or when implementing an operator, the Worker instances must be disposed via {@link com.liang.rxjava3.core.Scheduler.Worker#dispose()}.
     * <p>
     ...
     * <p>
     * The default value of this scheduler can be overridden at initialization time via the
     * {@link RxJavaPlugins#setInitIoSchedulerHandler(com.liang.rxjava3.functions.Function)} plugin method.
     * Note that due to possible initialization cycles, using any of the other scheduler-returning methods will
     * result in a {@link NullPointerException}.
     * Once the {@code Schedulers} class has been initialized, you can override the returned {@code Scheduler} instance
     * via the {@link RxJavaPlugins#setIoSchedulerHandler(com.liang.rxjava3.functions.Function)} method.
     * <p>
     * It is possible to create a fresh instance of this scheduler with a custom {@link ThreadFactory}, via the
     ...
     * (J2EE) container to unload properly.
     * <p>Operators on the base reactive classes that use this scheduler are marked with the
     * &#64;{@link com.liang.rxjava3.annotations.SchedulerSupport SchedulerSupport}({@link com.liang.rxjava3.annotations.SchedulerSupport#IO IO})
     * annotation.
     * <p>
     * When the {@link com.liang.rxjava3.core.Scheduler.Worker Scheduler.Worker} is disposed,
    ...
    /**
     * Returns a default, shared {@link Scheduler} instance whose {@link com.liang.rxjava3.core.Scheduler.Worker}
     ...
     * the Worker instances must be disposed via {@link com.liang.rxjava3.core.Scheduler.Worker#dispose()}.
     * <p>
     * Unhandled errors will be delivered to the scheduler Thread's {@link Thread.UncaughtExceptionHandler}.
     * <p>
     * You can control certain properties of this standard scheduler via system properties that have to be set
     ...
     * <p>
     * The default value of this scheduler can be overridden at initialization time via the
     * {@link RxJavaPlugins#setInitNewThreadSchedulerHandler(com.liang.rxjava3.functions.Function)} plugin method.
     * Note that due to possible initialization cycles, using any of the other scheduler-returning methods will
     * result in a {@link NullPointerException}.
     * Once the {@code Schedulers} class has been initialized, you can override the returned {@code Scheduler} instance
     * via the {@link RxJavaPlugins#setNewThreadSchedulerHandler(com.liang.rxjava3.functions.Function)} method.
     * <p>
     * It is possible to create a fresh instance of this scheduler with a custom {@link ThreadFactory}, via the
     ...
     * (J2EE) container to unload properly.
     * <p>Operators on the base reactive classes that use this scheduler are marked with the
     * &#64;{@link com.liang.rxjava3.annotations.SchedulerSupport SchedulerSupport}({@link com.liang.rxjava3.annotations.SchedulerSupport#NEW_THREAD NEW_TRHEAD})
     * annotation.
     ...
     * <p>
     * The default value of this scheduler can be overridden at initialization time via the
     * {@link RxJavaPlugins#setInitSingleSchedulerHandler(com.liang.rxjava3.functions.Function)} plugin method.
     * Note that due to possible initialization cycles, using any of the other scheduler-returning methods will
     * result in a {@link NullPointerException}.
     * Once the {@code Schedulers} class has been initialized, you can override the returned {@code Scheduler} instance
     * via the {@link RxJavaPlugins#setSingleSchedulerHandler(com.liang.rxjava3.functions.Function)} method.
     * <p>
     * It is possible to create a fresh instance of this scheduler with a custom {@link ThreadFactory}, via the
     ...
     * (J2EE) container to unload properly.
     * <p>Operators on the base reactive classes that use this scheduler are marked with the
     * &#64;{@link com.liang.rxjava3.annotations.SchedulerSupport SchedulerSupport}({@link com.liang.rxjava3.annotations.SchedulerSupport#SINGLE SINGLE})
     * annotation.
     ...
     * <p>
     * Tasks submitted to the {@link com.liang.rxjava3.core.Scheduler.Worker Scheduler.Worker} of this {@code Scheduler} are also not interruptible. Use the
     ...
     * {@link com.liang.rxjava3.disposables.Disposable#dispose()}. In addition, tasks scheduled with
     * a time delay or periodically will use the {@link #single()} scheduler for the timed waiting
     * before posting the actual task to the given executor.
     * <p>
     ...
     * <p>
     * This type of scheduler is less sensitive to leaking {@link com.liang.rxjava3.core.Scheduler.Worker Scheduler.Worker} instances, although
     * not disposing a worker that has timed/delayed tasks not cancelled by other means may leak resources and/or
     * execute those tasks "unexpectedly".
     * <p>
     ...
     * calls to it.
     * <p>
     * The tasks scheduled by the returned {@code Scheduler} and its {@link com.liang.rxjava3.core.Scheduler.Worker Scheduler.Worker}
     ...
     * @param executor
     *          the executor to wrap
     * @param interruptibleWorker if {@code true}, the tasks submitted to the {@link com.liang.rxjava3.core.Scheduler.Worker Scheduler.Worker} will
