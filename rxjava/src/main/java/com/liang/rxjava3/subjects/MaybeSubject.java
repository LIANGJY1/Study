 ...
 * <p>
 * Since a {@code MaybeSubject} is a {@link com.liang.rxjava3.core.Maybe}, calling {@code onSuccess}, {@code onError}
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code MaybeSubject} does not operate by default on a particular {@link com.liang.rxjava3.core.Scheduler} and
 ...
 *  {@link com.liang.rxjava3.plugins.RxJavaPlugins#onError(Throwable)} (multiple times if multiple {@code MaybeObserver}s
 *  cancel at once).
