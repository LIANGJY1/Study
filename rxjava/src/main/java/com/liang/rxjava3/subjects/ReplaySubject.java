...
import com.liang.rxjava3.internal.functions.ObjectHelper;
 ...
 * <p>
 * Since a {@code ReplaySubject} is an {@link com.liang.rxjava3.core.Observable}, it does not support backpressure.
 * <p>
 * When this {@code ReplaySubject} is terminated via {@link #onError(Throwable)} or {@link #onComplete()},
 * late {@link com.liang.rxjava3.core.Observer}s will receive the retained/cached items first (if any) followed by the respective
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code ReplaySubject} does not operate by default on a particular {@link com.liang.rxjava3.core.Scheduler} and
