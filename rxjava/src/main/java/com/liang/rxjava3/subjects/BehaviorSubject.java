...
import com.liang.rxjava3.internal.util.AppendOnlyLinkedArrayList.NonThrowingPredicate;
 ...
 * <p>
 * Since a {@code BehaviorSubject} is an {@link com.liang.rxjava3.core.Observable}, it does not support backpressure.
 * <p>
 * When this {@code BehaviorSubject} is terminated via {@link #onError(Throwable)} or {@link #onComplete()}, the
 * last observed item (if any) is cleared and late {@link com.liang.rxjava3.core.Observer}s only receive
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code BehaviorSubject} does not operate by default on a particular {@link com.liang.rxjava3.core.Scheduler} and
 ...
 *  {@link com.liang.rxjava3.plugins.RxJavaPlugins#onError(Throwable)} (multiple times if multiple {@code Observer}s
 *  cancel at once).
