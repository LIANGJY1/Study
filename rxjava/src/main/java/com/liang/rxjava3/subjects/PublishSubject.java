 ...
 * <p>
 * Since a {@code PublishSubject} is an {@link com.liang.rxjava3.core.Observable}, it does not support backpressure.
 * <p>
 * When this {@code PublishSubject} is terminated via {@link #onError(Throwable)} or {@link #onComplete()},
 * late {@link com.liang.rxjava3.core.Observer}s only receive the respective terminal event.
 * <p>
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code PublishSubject} does not operate by default on a particular {@link com.liang.rxjava3.core.Scheduler} and
