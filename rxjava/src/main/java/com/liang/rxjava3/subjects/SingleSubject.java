 ...
 * <p>
 * Since a {@code SingleSubject} is a {@link com.liang.rxjava3.core.Single}, calling {@code onSuccess} or {@code onError}
 ...
 * the {@link com.liang.rxjava3.plugins.RxJavaPlugins#onError(Throwable)} global error handler.
 * <p>
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code SingleSubject} does not operate by default on a particular {@link com.liang.rxjava3.core.Scheduler} and
 ...
 *  {@link com.liang.rxjava3.plugins.RxJavaPlugins#onError(Throwable)} (multiple times if multiple {@code SingleObserver}s
 *  cancel at once).
