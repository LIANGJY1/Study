...
import com.liang.rxjava3.internal.observers.BasicIntQueueDisposable;
import com.liang.rxjava3.internal.util.ExceptionHelper;
import com.liang.rxjava3.operators.SimpleQueue;
import com.liang.rxjava3.operators.SpscLinkedArrayQueue;
 ...
 * <p>
 * Since a {@code UnicastSubject} is an {@link com.liang.rxjava3.core.Observable}, it does not support backpressure.
 * <p>
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code UnicastSubject} does not operate by default on a particular {@link com.liang.rxjava3.core.Scheduler} and
 ...
 *  {@link com.liang.rxjava3.plugins.RxJavaPlugins#onError(Throwable)}.
