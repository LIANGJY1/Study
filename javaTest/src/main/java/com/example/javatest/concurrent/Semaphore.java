 ...
 * binary semaphore has the property (unlike many {@link com.example.javatest.concurrent.locks.Lock}
...
public class Semaphore implements java.io.Serializable {
     ...
     * {@link #tryAcquire(long, com.example.javatest.concurrent.TimeUnit) tryAcquire(0, TimeUnit.SECONDS)}
     ...
     * @throws InterruptedException if the current thread is interrupted
     */
    public boolean tryAcquire(long timeout, com.example.javatest.concurrent.TimeUnit unit)
     ...
     * long, com.example.javatest.concurrent.TimeUnit) tryAcquire(permits, 0, TimeUnit.SECONDS)}
     * which is almost equivalent (it also detects interruption).
     *
     * @param permits the number of permits to acquire
