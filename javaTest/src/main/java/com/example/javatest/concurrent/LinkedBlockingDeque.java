...
import com.example.javatest.concurrent.BlockingDeque;
...
public class LinkedBlockingDeque<E>
     ...
     * @throws InterruptedException {@inheritDoc}
     */
    public boolean offerFirst(E e, long timeout, com.example.javatest.concurrent.TimeUnit unit)
     ...
     * @throws InterruptedException {@inheritDoc}
     */
    public boolean offerLast(E e, long timeout, com.example.javatest.concurrent.TimeUnit unit)
        throws InterruptedException {
        if (e == null) throw new NullPointerException();
        Node<E> node = new Node<E>(e);
        long nanos = unit.toNanos(timeout);
    ...
    public E pollFirst(long timeout, com.example.javatest.concurrent.TimeUnit unit)
        throws InterruptedException {
        long nanos = unit.toNanos(timeout);
        final ReentrantLock lock = this.lock;
        lock.lockInterruptibly();
    ...
    public E pollLast(long timeout, com.example.javatest.concurrent.TimeUnit unit)
        throws InterruptedException {
        long nanos = unit.toNanos(timeout);
        final ReentrantLock lock = this.lock;
        lock.lockInterruptibly();
