...
import com.example.javatest.concurrent.TransferQueue;
import com.example.javatest.concurrent.locks.LockSupport;
import java.util.function.Consumer;
import java.util.function.Predicate;

/**
 * An unbounded {@link com.example.javatest.concurrent.TransferQueue} based on linked nodes.
...
public class LinkedTransferQueue<E> extends AbstractQueue<E>
     ...
     *  {@link com.example.javatest.concurrent.BlockingQueue#offer(Object,long, com.example.javatest.concurrent.TimeUnit) BlockingQueue.offer})
     * @throws NullPointerException if the specified element is null
     */
     ...
     * {@link #take} or timed {@link #poll(long, com.example.javatest.concurrent.TimeUnit) poll}),
     ...
     * @throws NullPointerException if the specified element is null
     */
    public boolean tryTransfer(E e, long timeout, com.example.javatest.concurrent.TimeUnit unit)
