...
import com.example.javatest.concurrent.ConcurrentNavigableMap;
import com.example.javatest.concurrent.ThreadLocalRandom;
import com.example.javatest.concurrent.atomic.LongAdder;
...
/**
 * A scalable concurrent {@link com.example.javatest.concurrent.ConcurrentNavigableMap} implementation.
...
public class ConcurrentSkipListMap<K,V> extends AbstractMap<K,V>
    implements com.example.javatest.concurrent.ConcurrentNavigableMap<K,V>, Cloneable, Serializable {
    /*
    ...
    private V doPut(K key, V value, boolean onlyIfAbsent) {
        ...
        for (;;) {
            ...
            if (b != null) {
                ...
                if (z != null) {
                    int lr = com.example.javatest.concurrent.ThreadLocalRandom.nextSecondarySeed();
     ...
     */
    final SimpleImmutableEntry<K,V> findFirstEntry() {
        Node<K,V> b, n; V v;
        if ((b = baseHead()) != null) {
            while ((n = b.next) != null) {
                if ((v = n.val) == null)
     ...
     */
    private SimpleImmutableEntry<K,V> doRemoveFirstEntry() {
        Node<K,V> b, n; V v;
        if ((b = baseHead()) != null) {
            while ((n = b.next) != null) {
     ...
     */
    final SimpleImmutableEntry<K,V> findLastEntry() {
        for (;;) {
            Node<K,V> n; V v;
            if ((n = findLast()) == null)
                return null;
     ...
     */
    final SimpleImmutableEntry<K,V> findNearEntry(K key, int rel,
                                                              Comparator<? super K> cmp) {
        for (;;) {
            Node<K,V> n; V v;
    ...
    public com.example.javatest.concurrent.ConcurrentNavigableMap<K,V> descendingMap() {
        com.example.javatest.concurrent.ConcurrentNavigableMap<K,V> dm;
    ...
    public boolean equals(Object o) {
        ...
        try {
            ...
            Iterator<? extends Entry<?,?>> it = m.entrySet().iterator();
     ...
     */
    public com.example.javatest.concurrent.ConcurrentNavigableMap<K,V> subMap(K fromKey,
     ...
     * @throws IllegalArgumentException {@inheritDoc}
     */
    public com.example.javatest.concurrent.ConcurrentNavigableMap<K,V> headMap(K toKey,
                                                                    boolean inclusive) {
        if (toKey == null)
            throw new NullPointerException();
        return new SubMap<K,V>
     ...
     * @throws IllegalArgumentException {@inheritDoc}
     */
    public com.example.javatest.concurrent.ConcurrentNavigableMap<K,V> tailMap(K fromKey,
                                                                    boolean inclusive) {
        if (fromKey == null)
            throw new NullPointerException();
        return new SubMap<K,V>
     ...
     * @throws IllegalArgumentException {@inheritDoc}
     */
    public com.example.javatest.concurrent.ConcurrentNavigableMap<K,V> subMap(K fromKey, K toKey) {
    ...
    static final class KeySet<K,V>
        ...
        final com.example.javatest.concurrent.ConcurrentNavigableMap<K,V> m;
        KeySet(com.example.javatest.concurrent.ConcurrentNavigableMap<K,V> map) { m = map; }
    ...
    static final class Values<K,V> extends AbstractCollection<V> {
        final com.example.javatest.concurrent.ConcurrentNavigableMap<K,V> m;
        Values(com.example.javatest.concurrent.ConcurrentNavigableMap<K,V> map) {
            m = map;
        }
    ...
    static final class EntrySet<K,V> extends AbstractSet<Entry<K,V>> {
        final com.example.javatest.concurrent.ConcurrentNavigableMap<K,V> m;
        EntrySet(com.example.javatest.concurrent.ConcurrentNavigableMap<K,V> map) {
            m = map;
        }
