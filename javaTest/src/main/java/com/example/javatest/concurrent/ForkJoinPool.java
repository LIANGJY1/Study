...
import com.example.javatest.concurrent.CompletableFuture;
import com.example.javatest.concurrent.CountedCompleter;
...
import com.example.javatest.concurrent.ForkJoinWorkerThread;
...
import com.example.javatest.concurrent.ThreadLocalRandom;
...
/**
 * An {@link com.example.javatest.concurrent.ExecutorService} for running {@link com.example.javatest.concurrent.ForkJoinTask}s.
 ...
 *    <td> {@link #execute(com.example.javatest.concurrent.ForkJoinTask)}</td>
 *    <td> {@link com.example.javatest.concurrent.ForkJoinTask#fork}</td>
 *  </tr>
 *  <tr>
 *    <th scope="row" style="text-align:left"> Await and obtain result</th>
 *    <td> {@link #invoke(com.example.javatest.concurrent.ForkJoinTask)}</td>
 *    <td> {@link com.example.javatest.concurrent.ForkJoinTask#invoke}</td>
 *  </tr>
 *  <tr>
 *    <th scope="row" style="text-align:left"> Arrange exec and obtain Future</th>
 *    <td> {@link #submit(com.example.javatest.concurrent.ForkJoinTask)}</td>
 *    <td> {@link com.example.javatest.concurrent.ForkJoinTask#fork} (ForkJoinTasks <em>are</em> Futures)</td>
 *  </tr>
 * </table>
 *
 ...
 * <ul>
 * <li>{@code com.example.javatest.concurrent.ForkJoinPool.common.parallelism}
 * - the parallelism level, a non-negative integer
 * <li>{@code com.example.javatest.concurrent.ForkJoinPool.common.threadFactory}
 * - the class name of a {@link ForkJoinWorkerThreadFactory}.
 * The {@linkplain ClassLoader#getSystemClassLoader() system class loader}
 * is used to load this class.
 * <li>{@code com.example.javatest.concurrent.ForkJoinPool.common.exceptionHandler}
 * - the class name of a {@link UncaughtExceptionHandler}.
 * The {@linkplain ClassLoader#getSystemClassLoader() system class loader}
 * is used to load this class.
 * <li>{@code com.example.javatest.concurrent.ForkJoinPool.common.maximumSpares}
 ...
 * {@link com.example.javatest.concurrent.RejectedExecutionException}) only when the pool is shut down
...
public class ForkJoinPool extends AbstractExecutorService {
    ...
    static final class WorkQueue {
        ...
        com.example.javatest.concurrent.ForkJoinTask<?>[] array;   // the queued tasks; power of 2 size
        ...
        static final com.example.javatest.concurrent.ForkJoinTask<?> getSlot(com.example.javatest.concurrent.ForkJoinTask<?>[] a, int i) {
            return (com.example.javatest.concurrent.ForkJoinTask<?>)QA.getAcquire(a, i);
        }
        static final com.example.javatest.concurrent.ForkJoinTask<?> getAndClearSlot(com.example.javatest.concurrent.ForkJoinTask<?>[] a,
                                                                          int i) {
            return (com.example.javatest.concurrent.ForkJoinTask<?>)QA.getAndSet(a, i, null);
        }
        static final void setSlotVolatile(com.example.javatest.concurrent.ForkJoinTask<?>[] a, int i,
                                          com.example.javatest.concurrent.ForkJoinTask<?> v) {
            QA.setVolatile(a, i, v);
        }
        static final boolean casSlotToNull(com.example.javatest.concurrent.ForkJoinTask<?>[] a, int i,
                                           com.example.javatest.concurrent.ForkJoinTask<?> c) {
        ...
        WorkQueue(int config) {
            array = new com.example.javatest.concurrent.ForkJoinTask<?>[INITIAL_QUEUE_CAPACITY];
            this.config = config;
            owner = null;
            phase = -1;
        }
         ...
         * @throws com.example.javatest.concurrent.RejectedExecutionException if array cannot be resized
         */
        final void push(com.example.javatest.concurrent.ForkJoinTask<?> task, ForkJoinPool pool) {
            com.example.javatest.concurrent.ForkJoinTask<?>[] a = array;
         ...
         */
        final boolean lockedPush(com.example.javatest.concurrent.ForkJoinTask<?> task) {
            com.example.javatest.concurrent.ForkJoinTask<?>[] a = array;
        ...
        final void growArray() {
            com.example.javatest.concurrent.ForkJoinTask<?>[] oldArray = array, newArray;
            int s = top - 1, oldCap, newCap;
            if (oldArray != null && (oldCap = oldArray.length) > 0 &&
                (newCap = oldCap << 1) > 0) { // skip if disabled
                try {
                    newArray = new com.example.javatest.concurrent.ForkJoinTask<?>[newCap];
                } catch (Throwable ex) {
                    top = s;
                    if (owner == null)
                        source = 0; // unlock
                    throw new com.example.javatest.concurrent.RejectedExecutionException(
                        "Queue capacity exceeded");
                }
                int newMask = newCap - 1, oldMask = oldCap - 1;
                for (int k = oldCap; k > 0; --k, --s) {
                    com.example.javatest.concurrent.ForkJoinTask<?> x;        // poll old, push to new
         ...
         */
        private com.example.javatest.concurrent.ForkJoinTask<?> pop() {
            com.example.javatest.concurrent.ForkJoinTask<?> t = null;
            int s = top, cap; com.example.javatest.concurrent.ForkJoinTask<?>[] a;
         ...
         */
        final boolean tryUnpush(com.example.javatest.concurrent.ForkJoinTask<?> task) {
            int s = top, cap; com.example.javatest.concurrent.ForkJoinTask<?>[] a;
            if ((a = array) != null && (cap = a.length) > 0 && base != s-- &&
         ...
         */
        final boolean externalTryUnpush(com.example.javatest.concurrent.ForkJoinTask<?> task) {
            boolean taken = false;
            for (;;) {
                int s = top, cap, k; com.example.javatest.concurrent.ForkJoinTask<?>[] a;
         ...
         */
        final boolean tryRemove(com.example.javatest.concurrent.ForkJoinTask<?> task, boolean owned) {
            boolean taken = false;
            int p = top, cap; com.example.javatest.concurrent.ForkJoinTask<?>[] a; com.example.javatest.concurrent.ForkJoinTask<?> t;
         ...
         */
        final com.example.javatest.concurrent.ForkJoinTask<?> tryPoll() {
            int cap, b, k; com.example.javatest.concurrent.ForkJoinTask<?>[] a;
            if ((a = array) != null && (cap = a.length) > 0) {
                com.example.javatest.concurrent.ForkJoinTask<?> t = getSlot(a, k = (cap - 1) & (b = base));
         ...
         */
        final com.example.javatest.concurrent.ForkJoinTask<?> nextLocalTask(int cfg) {
            com.example.javatest.concurrent.ForkJoinTask<?> t = null;
            int s = top, cap; com.example.javatest.concurrent.ForkJoinTask<?>[] a;
            if ((a = array) != null && (cap = a.length) > 0) {
                for (int b, d;;) {
         ...
         */
        final com.example.javatest.concurrent.ForkJoinTask<?> nextLocalTask() {
         ...
         */
        final com.example.javatest.concurrent.ForkJoinTask<?> peek() {
            VarHandle.acquireFence();
            int cap; com.example.javatest.concurrent.ForkJoinTask<?>[] a;
         ...
         * given queue.
         */
        final void topLevelExec(com.example.javatest.concurrent.ForkJoinTask<?> task, WorkQueue q) {
            ...
            source = 0;
            if ((cfg & INNOCUOUS) != 0)
                com.example.javatest.concurrent.ThreadLocalRandom.eraseThreadLocals(Thread.currentThread());
        }
         ...
         */
        final int helpComplete(com.example.javatest.concurrent.ForkJoinTask<?> task, boolean owned, int limit) {
            int status = 0, cap, k, p, s; com.example.javatest.concurrent.ForkJoinTask<?>[] a; com.example.javatest.concurrent.ForkJoinTask<?> t;
            while (task != null && (status = task.status) >= 0 &&
                   (a = array) != null && (cap = a.length) > 0 &&
                   (t = a[k = (cap - 1) & (s = (p = top) - 1)])
                   instanceof com.example.javatest.concurrent.CountedCompleter) {
                com.example.javatest.concurrent.CountedCompleter<?> f = (com.example.javatest.concurrent.CountedCompleter<?>)t;
                boolean taken = false;
        ...
        final void helpAsyncBlocker(ManagedBlocker blocker) {
            int cap, b, d, k; com.example.javatest.concurrent.ForkJoinTask<?>[] a; com.example.javatest.concurrent.ForkJoinTask<?> t;
        ...
        final void initializeInnocuousWorker() {
            ...
            com.example.javatest.concurrent.ThreadLocalRandom.setInheritedAccessControlContext(t, acc);
            com.example.javatest.concurrent.ThreadLocalRandom.eraseThreadLocals(t);
        }
        ...
        static {
            try {
                QA = MethodHandles.arrayElementVarHandle(com.example.javatest.concurrent.ForkJoinTask[].class);
     ...
     * "com.example.javatest.concurrent.ForkJoinPool.common.maximumSpares" system
    ...
    final void registerWorker(WorkQueue w) {
        ...
        com.example.javatest.concurrent.ThreadLocalRandom.localInit();
        int seed = com.example.javatest.concurrent.ThreadLocalRandom.getProbe();
        if (w != null && lock != null) {
            int modebits = (mode & FIFO) | w.config;
            w.array = new com.example.javatest.concurrent.ForkJoinTask<?>[INITIAL_QUEUE_CAPACITY];
    ...
    final void deregisterWorker(ForkJoinWorkerThread wt, Throwable ex) {
        ...
        if (wt != null && (w = wt.workQueue) != null && lock != null) {
            ...
            for (com.example.javatest.concurrent.ForkJoinTask<?> t; (t = w.pop()) != null; )
                com.example.javatest.concurrent.ForkJoinTask.cancelIgnoringExceptions(t); // cancel tasks
        }

        if (!tryTerminate(false, false) && w != null && (cfg & SRC) != 0)
            signalWork();                            // possibly replace worker
        if (ex != null)
            com.example.javatest.concurrent.ForkJoinTask.rethrow(ex);
    }
    ...
    private int scan(WorkQueue w, int prevSrc, int r) {
        ...
        for (int step = (r >>> 16) | 1, i = n; i > 0; --i, r += step) {
            int j, cap, b; WorkQueue q; com.example.javatest.concurrent.ForkJoinTask<?>[] a;
            if ((q = qs[j = r & (n - 1)]) != null && // poll at qs[j].array[k]
                (a = q.array) != null && (cap = a.length) > 0) {
                int k = (cap - 1) & (b = q.base), nextBase = b + 1;
                int nextIndex = (cap - 1) & nextBase, src = j | SRC;
                com.example.javatest.concurrent.ForkJoinTask<?> t = WorkQueue.getSlot(a, k);
                if (q.base != b)                // inconsistent
                    return prevSrc;
                else if (t != null && WorkQueue.casSlotToNull(a, k, t)) {
                    q.base = nextBase;
                    com.example.javatest.concurrent.ForkJoinTask<?> next = a[nextIndex];
    ...
    private int awaitWork(WorkQueue w) {
        ...
        if ((md = mode) < 0)                 // pool is terminating
            ...
            for (int i = 0; i < n; i += 2) {
                WorkQueue q; com.example.javatest.concurrent.ForkJoinTask<?>[] a; int cap, b;
    ...
    final boolean canStop() {
        outer: for (long oldSum = 0L;;) { // repeat until stable
            ...
            for (int i = 1; i < qs.length; i += 2) { // scan submitters
                WorkQueue q; com.example.javatest.concurrent.ForkJoinTask<?>[] a; int s = 0, cap;
     ...
     */
    final int helpJoin(com.example.javatest.concurrent.ForkJoinTask<?> task, WorkQueue w, boolean canHelp) {
        int s = 0;
        if (task != null && w != null) {
            ...
            outer: for (;;) {
                if ((s = task.status) < 0)
                    ...
                    if (mode < 0)
                        com.example.javatest.concurrent.ForkJoinTask.cancelIgnoringExceptions(task);
                    ...
                    for (int i = n; i > 0; i -= 2, r += 2) {
                        int j; WorkQueue q, x, y; com.example.javatest.concurrent.ForkJoinTask<?>[] a;
                        if ((q = qs[j = r & m]) != null) {
     ...
     * @return task status on exit
     */
    final int helpComplete(com.example.javatest.concurrent.ForkJoinTask<?> task, WorkQueue w, boolean owned) {
        int s = 0;
        if (task != null && w != null) {
            int r = w.config;
                ...
                if (locals) {                     // try locals before scanning
                    ...
                    for (int i = n; i > 0; --i, ++r) {
                        ...
                        if ((q = qs[j = r & (n - 1)]) != null &&
                            ...
                            int k = (cap - 1) & (b = q.base), nextBase = b + 1;
                            com.example.javatest.concurrent.ForkJoinTask<?> t = WorkQueue.getSlot(a, k);
                            if (t instanceof com.example.javatest.concurrent.CountedCompleter) {
                                com.example.javatest.concurrent.CountedCompleter<?> f = (CountedCompleter<?>)t;
     ...
     */
    private com.example.javatest.concurrent.ForkJoinTask<?> pollScan(boolean submissionsOnly) {
        VarHandle.acquireFence();
    ...
    final int helpQuiescePool(WorkQueue w, long nanos, boolean interruptible) {
        ...
        for (boolean active = true, locals = true;;) {
            ...
            if (locals) {  // run local tasks before (re)polling
                locals = false;
                for (com.example.javatest.concurrent.ForkJoinTask<?> u; (u = w.nextLocalTask(cfg)) != null;)
                    u.doExec();
            }
            WorkQueue[] qs = queues;
            int n = (qs == null) ? 0 : qs.length;
            for (int i = n; i > 0; --i, ++r) {
                int j, b, cap; WorkQueue q; com.example.javatest.concurrent.ForkJoinTask<?>[] a;
    ...
    final int externalHelpQuiescePool(long nanos, boolean interruptible) {
        for (long startTime = System.nanoTime(), parkTime = 0L;;) {
            com.example.javatest.concurrent.ForkJoinTask<?> t;
     ...
     */
    final com.example.javatest.concurrent.ForkJoinTask<?> nextTaskFor(WorkQueue w) {
        com.example.javatest.concurrent.ForkJoinTask<?> t;
    ...
    final WorkQueue submissionQueue() {
        int r;
        if ((r = com.example.javatest.concurrent.ThreadLocalRandom.getProbe()) == 0) {
            com.example.javatest.concurrent.ThreadLocalRandom.localInit();           // initialize caller's probe
            r = com.example.javatest.concurrent.ThreadLocalRandom.getProbe();
        }
        for (int id = r << 1;;) {                    // even indices only
            ...
            if ((md & SHUTDOWN) != 0 || qs == null || (n = qs.length) <= 0)
                ...
                id = (r = com.example.javatest.concurrent.ThreadLocalRandom.advanceProbe(r)) << 1;
            else
                return q;
        }
    }
     ...
     * @param task the task. Caller must ensure non-null.
     */
    final void externalPush(com.example.javatest.concurrent.ForkJoinTask<?> task) {
        WorkQueue q;
        if ((q = submissionQueue()) == null)
            throw new com.example.javatest.concurrent.RejectedExecutionException(); // shutdown or disabled
     ...
     */
    private <T> com.example.javatest.concurrent.ForkJoinTask<T> externalSubmit(com.example.javatest.concurrent.ForkJoinTask<T> task) {
    ...
    static WorkQueue commonQueue() {
        ...
        int r = com.example.javatest.concurrent.ThreadLocalRandom.getProbe(), n;
    ...
    private boolean tryTerminate(boolean now, boolean enable) {
        ...
        for (boolean rescan = true;;) { // repeat until no changes
            ...
            for (com.example.javatest.concurrent.ForkJoinTask<?> t; (t = pollScan(false)) != null; ) {
                changed = true;
                com.example.javatest.concurrent.ForkJoinTask.cancelIgnoringExceptions(t); // help cancel
            }
     ...
     * int, int, int, Predicate, long, com.example.javatest.concurrent.TimeUnit)}).
     *
    ...
    public ForkJoinPool() {
        this(Math.min(MAX_CAP, Runtime.getRuntime().availableProcessors()),
             ...
             0, MAX_CAP, 1, null, DEFAULT_KEEPALIVE, com.example.javatest.concurrent.TimeUnit.MILLISECONDS);
    }
     ...
     * long, com.example.javatest.concurrent.TimeUnit)}).
     *
     ...
     * com.example.javatest.concurrent.RejectedExecutionException} is thrown.  But if this predicate
    ...
    private ForkJoinPool(byte forCommonPoolOnly) {
        ...
        try {  // ignore exceptions in accessing/parsing properties
            fac = (ForkJoinWorkerThreadFactory) newInstanceFromSystemProperty(
                "com.example.javatest.concurrent.ForkJoinPool.common.threadFactory");
            handler = (UncaughtExceptionHandler) newInstanceFromSystemProperty(
                "com.example.javatest.concurrent.ForkJoinPool.common.exceptionHandler");
            String pp = System.getProperty
                ("com.example.javatest.concurrent.ForkJoinPool.common.parallelism");
            if (pp != null)
     ...
     * @throws com.example.javatest.concurrent.RejectedExecutionException if the task cannot be
     *         scheduled for execution
     */
    public <T> T invoke(com.example.javatest.concurrent.ForkJoinTask<T> task) {
        externalSubmit(task);
     ...
     *         scheduled for execution
     */
    public void execute(com.example.javatest.concurrent.ForkJoinTask<?> task) {
        externalSubmit(task);
    }
    ...
    public void execute(Runnable task) {
        externalSubmit((task instanceof com.example.javatest.concurrent.ForkJoinTask<?>)
                       ? (com.example.javatest.concurrent.ForkJoinTask<Void>) task // avoid re-wrap
                       : new com.example.javatest.concurrent.ForkJoinTask.RunnableExecuteAction(task));
    }
     ...
     *         scheduled for execution
     */
    public <T> com.example.javatest.concurrent.ForkJoinTask<T> submit(com.example.javatest.concurrent.ForkJoinTask<T> task) {
     ...
     */
    @Override
    public <T> com.example.javatest.concurrent.ForkJoinTask<T> submit(com.example.javatest.concurrent.Callable<T> task) {
        return externalSubmit(new com.example.javatest.concurrent.ForkJoinTask.AdaptedCallable<T>(task));
    }
     ...
     */
    @Override
    public <T> com.example.javatest.concurrent.ForkJoinTask<T> submit(Runnable task, T result) {
        return externalSubmit(new com.example.javatest.concurrent.ForkJoinTask.AdaptedRunnable<T>(task, result));
    }
    ...
    @Override
    @SuppressWarnings("unchecked")
    public com.example.javatest.concurrent.ForkJoinTask<?> submit(Runnable task) {
        return externalSubmit((task instanceof com.example.javatest.concurrent.ForkJoinTask<?>)
            ? (com.example.javatest.concurrent.ForkJoinTask<Void>) task // avoid re-wrap
            : new com.example.javatest.concurrent.ForkJoinTask.AdaptedRunnableAction(task));
    }
    ...
    public <T> List<com.example.javatest.concurrent.Future<T>> invokeAll(Collection<? extends com.example.javatest.concurrent.Callable<T>> tasks) {
        ArrayList<com.example.javatest.concurrent.Future<T>> futures = new ArrayList<>(tasks.size());
        try {
            for (com.example.javatest.concurrent.Callable<T> t : tasks) {
                com.example.javatest.concurrent.ForkJoinTask<T> f =
                    new com.example.javatest.concurrent.ForkJoinTask.AdaptedInterruptibleCallable<T>(t);
                futures.add(f);
                externalSubmit(f);
            }
            for (int i = futures.size() - 1; i >= 0; --i)
                ((com.example.javatest.concurrent.ForkJoinTask<?>)futures.get(i)).awaitPoolInvoke(this);
            return futures;
        } catch (Throwable t) {
            for (com.example.javatest.concurrent.Future<T> e : futures)
                com.example.javatest.concurrent.ForkJoinTask.cancelIgnoringExceptions(e);
            throw t;
        }
    }
    ...
    public <T> List<com.example.javatest.concurrent.Future<T>> invokeAll(Collection<? extends com.example.javatest.concurrent.Callable<T>> tasks,
        ...
        try {
            ...
            for (int i = futures.size() - 1; i >= 0; --i) {
                com.example.javatest.concurrent.Future<T> f = futures.get(i);
                if (!f.isDone()) {
                    if (timedOut)
                        com.example.javatest.concurrent.ForkJoinTask.cancelIgnoringExceptions(f);
                    else {
                        ((com.example.javatest.concurrent.ForkJoinTask<T>)f).awaitPoolInvoke(this, ns);
    ...
    static final class InvokeAnyRoot<E> extends com.example.javatest.concurrent.ForkJoinTask<E> {
        ...
        final void tryComplete(com.example.javatest.concurrent.Callable<E> c) { // called by InvokeAnyTasks
            Throwable ex = null;
            boolean failed;
    ...
    static final class InvokeAnyTask<E> extends com.example.javatest.concurrent.ForkJoinTask<E> {
        private static final long serialVersionUID = 2838392045355241008L;
        final InvokeAnyRoot<E> root;
        @SuppressWarnings("serial") // Conditionally serializable
        final com.example.javatest.concurrent.Callable<E> callable;
        transient volatile Thread runner;
        InvokeAnyTask(InvokeAnyRoot<E> root, com.example.javatest.concurrent.Callable<E> callable) {
            this.root = root;
    ...
    public <T> T invokeAny(Collection<? extends com.example.javatest.concurrent.Callable<T>> tasks)
        ...
        try {
            for (com.example.javatest.concurrent.Callable<T> c : tasks) {
                if (c == null)
                    throw new NullPointerException();
     ...
     */
    protected com.example.javatest.concurrent.ForkJoinTask<?> pollSubmission() {
     ...
     */
    protected int drainTasksTo(Collection<? super com.example.javatest.concurrent.ForkJoinTask<?>> c) {
        int count = 0;
        for (com.example.javatest.concurrent.ForkJoinTask<?> t; (t = pollScan(false)) != null; ) {
            c.add(t);
            ++count;
     ...
     * advisory notes for class {@link com.example.javatest.concurrent.ForkJoinTask} stating that
     ...
     * #awaitQuiescence(long, com.example.javatest.concurrent.TimeUnit)} but always returns {@code false}.
     *
     ...
     * in effect to {@link com.example.javatest.concurrent.ForkJoinTask#helpQuiesce}. Otherwise,
     ...
     * com.example.javatest.concurrent.ForkJoinTask#inForkJoinPool() running in a ForkJoinPool}, this
    ...
    @Override
    protected <T> com.example.javatest.concurrent.RunnableFuture<T> newTaskFor(Runnable runnable, T value) {
        return new com.example.javatest.concurrent.ForkJoinTask.AdaptedRunnable<T>(runnable, value);
    }
    ...
    static {
        ...
        try {
            String p = System.getProperty
                ("com.example.javatest.concurrent.ForkJoinPool.common.maximumSpares");
            if (p != null)
