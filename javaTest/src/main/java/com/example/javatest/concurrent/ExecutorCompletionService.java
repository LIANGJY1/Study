...
import com.example.javatest.concurrent.CompletionService;
...
public class ExecutorCompletionService<V> implements CompletionService<V> {
     ...
     * @throws NullPointerException       {@inheritDoc}
     */
    public com.example.javatest.concurrent.Future<V> submit(Runnable task, V result) {
        if (task == null) throw new NullPointerException();
    ...
    public com.example.javatest.concurrent.Future<V> take() throws InterruptedException {
        return completionQueue.take();
    }

    public com.example.javatest.concurrent.Future<V> poll() {
