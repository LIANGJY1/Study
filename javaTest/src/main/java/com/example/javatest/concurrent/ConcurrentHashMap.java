...
import com.example.javatest.concurrent.ConcurrentMap;
...
import com.example.javatest.concurrent.atomic.AtomicReference;
 ...
 * com.example.javatest.concurrentModificationException ConcurrentModificationException}.
 ...
 * com.example.javatest.concurrent.atomic.LongAdder} values and initializing via
 ...
 * com.example.javatest.concurrent.ForkJoinPool#commonPool()} that is used for all parallel
...
//                (c = cs[com.example.javatest.concurrent.ThreadLocalRandom.getProbe() & m]) == null ||
//                !(uncontended =
...
//                }
    ...
    private final void fullAddCount(long x, boolean wasUncontended) {
        int h;
        if ((h = com.example.javatest.concurrent.ThreadLocalRandom.getProbe()) == 0) {
            com.example.javatest.concurrent.ThreadLocalRandom.localInit();      // force initialization
            h = com.example.javatest.concurrent.ThreadLocalRandom.getProbe();
            wasUncontended = true;
        }
...
//            = U.objectFieldOffset(TreeBin.class, "lockState");
    ...
    abstract static class BulkTask<K,V,R> extends com.example.javatest.concurrent.CountedCompleter<R> {
    ...
    static final class ReduceKeysTask<K,V>
        ...
        public final void compute() {
            ...
            if ((reducer = this.reducer) != null) {
                ...
                result = r;
                com.example.javatest.concurrent.CountedCompleter<?> c;
