 ...
 *    <td headers="First FInsert FTimes">{@link #offerFirst(Object, long, com.example.javatest.concurrent.TimeUnit) offerFirst(e, time, unit)}</td>
 *  </tr>
 *  <tr>
 ...
 *    <td headers="First FRemove FTimes">{@link #pollFirst(long, com.example.javatest.concurrent.TimeUnit) pollFirst(time, unit)}</td>
 *  </tr>
 *  <tr>
 ...
 *    <td headers="Last LInsert LTimes">{@link #offerLast(Object, long, com.example.javatest.concurrent.TimeUnit) offerLast(e, time, unit)}</td>
 *  </tr>
 *  <tr>
 ...
 *    <td headers="Last LRemove LTimes">{@link #pollLast(long, com.example.javatest.concurrent.TimeUnit) pollLast(time, unit)}</td>
 *  </tr>
 *  <tr>
 ...
 * </table>
 *
 * <p>Like any {@link com.example.javatest.concurrent.BlockingQueue}, a {@code BlockingDeque} is thread safe,
 ...
 *  </tr>
 *  <tr>
 *    <th id="offer2" style="font-weight:normal; text-align:left">{@link #offer(Object, long, com.example.javatest.concurrent.TimeUnit) offer(e, time, unit)}</th>
 *    <td headers="Insert BDeque offer2">{@link #offerLast(Object, long, com.example.javatest.concurrent.TimeUnit) offerLast(e, time, unit)}</td>
 *  </tr>
 *  <tr>
 ...
 *  </tr>
 *  <tr>
 *    <th id="poll2" style="font-weight:normal; text-align:left">{@link #poll(long, com.example.javatest.concurrent.TimeUnit) poll(time, unit)}</th>
 *    <td headers="Remove BDeque poll2">{@link #pollFirst(long, com.example.javatest.concurrent.TimeUnit) pollFirst(time, unit)}</td>
 *  </tr>
 *  <tr>
...
public interface BlockingDeque<E> extends BlockingQueue<E>, Deque<E> {
     ...
     *         element prevents it from being added to this deque
     */
    boolean offerFirst(E e, long timeout, com.example.javatest.concurrent.TimeUnit unit)
     ...
     *         element prevents it from being added to this deque
     */
    boolean offerLast(E e, long timeout, com.example.javatest.concurrent.TimeUnit unit)
        throws InterruptedException;
     ...
     * @throws InterruptedException if interrupted while waiting
     */
    E pollFirst(long timeout, com.example.javatest.concurrent.TimeUnit unit)
        throws InterruptedException;
     ...
     * @throws InterruptedException if interrupted while waiting
     */
    E pollLast(long timeout, com.example.javatest.concurrent.TimeUnit unit)
        throws InterruptedException;
     ...
     * {@link #offerLast(Object,long, com.example.javatest.concurrent.TimeUnit) offerLast}.
     *
     * @param e the element to add
     ...
     *         element prevents it from being added to this deque
     */
    boolean offer(E e, long timeout, com.example.javatest.concurrent.TimeUnit unit)
        throws InterruptedException;
     ...
     *
     * <p>This method is equivalent to
     * {@link #pollFirst(long, com.example.javatest.concurrent.TimeUnit) pollFirst}.
     *
