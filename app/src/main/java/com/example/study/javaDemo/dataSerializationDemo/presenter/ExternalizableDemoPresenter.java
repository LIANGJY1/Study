...
public class ExternalizableDemoPresenter extends BasePresenter {
    /**
    ...
    public void saveObject(Object object, String externalFilesDirString) {
        ...
        try {
            oos = new ObjectOutputStream(new FileOutputStream(externalFilesDirString + "/teacher.out"));
    ...
    public Teacher readObject(String externalFilesDirString) {
        ObjectInputStream ois = null;
        try {
            ois = new ObjectInputStream(new FileInputStream(externalFilesDirString + "/teacher.out"));
