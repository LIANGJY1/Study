 ...
 * <p>
 * {@code AsyncProcessor} is a {@link com.liang.rxjava3.core.Flowable} as well as a {@link FlowableProcessor} and supports backpressure from the downstream but
 ...
 *  When the {@code AsyncProcessor} is subscribed to a {@link com.liang.rxjava3.core.Flowable}, the processor consumes this
 *  {@code Flowable} in an unbounded manner (requesting {@link Long#MAX_VALUE}) as only the very last upstream item is
 *  retained by it.
 *  </dd>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code AsyncProcessor} does not operate by default on a particular {@link com.liang.rxjava3.core.Scheduler} and
 ...
 *  {@link com.liang.rxjava3.plugins.RxJavaPlugins#onError(Throwable)} (multiple times if multiple {@code Subscriber}s
 *  cancel at once).
