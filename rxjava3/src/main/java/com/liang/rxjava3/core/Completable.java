...
import com.liang.rxjava3.internal.fuseable.*;
import com.liang.rxjava3.internal.jdk8.*;
import com.liang.rxjava3.internal.observers.*;
import com.liang.rxjava3.internal.operators.completable.*;
import com.liang.rxjava3.internal.operators.maybe.*;
import com.liang.rxjava3.internal.operators.mixed.*;
import com.liang.rxjava3.internal.operators.single.SingleDelayWithCompletable;
 ...
 * <p>
 * {@code Completable} behaves similarly to {@link java.util.Observable} except that it can only emit either
 ...
 * {@link com.liang.rxjava3.subjects.CompletableSubject CompletableSubject}.
 * <p>
 ...
 * {@link com.liang.rxjava3.observers.DisposableCompletableObserver DisposableCompletableObserver} instance.
 ...
 *
 * @see com.liang.rxjava3.observers.DisposableCompletableObserver
 */
public abstract class Completable implements CompletableSource {
    ...
    /**
     * Returns an {@link java.util.Observable} which will subscribe to this {@code Completable} and once that is completed then
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <@NonNull T> java.util.Observable<T> andThen(@NonNull ObservableSource<T> next) {
    ...
    /**
     * Returns an {@link java.util.Observable} which first delivers the events
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <@NonNull T> java.util.Observable<T> startWith(@NonNull ObservableSource<T> other) {
        Objects.requireNonNull(other, "other is null");
        return java.util.Observable.wrap(other).concatWith(this.toObservable());
    }
    ...
    /**
     * Returns an {@link java.util.Observable} which when subscribed to subscribes to this {@code Completable} and
