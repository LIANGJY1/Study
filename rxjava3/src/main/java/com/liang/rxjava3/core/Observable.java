...
import com.liang.rxjava3.annotations.*;
import com.liang.rxjava3.disposables.*;
import com.liang.rxjava3.exceptions.*;
import com.liang.rxjava3.functions.*;
import com.liang.rxjava3.internal.functions.*;
import com.liang.rxjava3.internal.jdk8.*;
import com.liang.rxjava3.internal.observers.*;
import com.liang.rxjava3.internal.operators.flowable.*;
import com.liang.rxjava3.internal.operators.maybe.MaybeToObservable;
import com.liang.rxjava3.internal.operators.mixed.*;
import com.liang.rxjava3.internal.operators.observable.*;
import com.liang.rxjava3.internal.operators.single.SingleToObservable;
import com.liang.rxjava3.internal.util.*;
import com.liang.rxjava3.observables.*;
import com.liang.rxjava3.observers.*;
import com.liang.rxjava3.operators.ScalarSupplier;
 ...
 * <p>
 * Unlike the {@code Observable} of version 1.x, {@link #subscribe(java.util.Observer)} does not allow external disposal
 * of a subscription and the {@link java.util.Observer} instance is expected to expose such capability.
 * <p>Example:
 * <pre><code>
 ...
 * @see Flowable
 * @see com.liang.rxjava3.observers.DisposableObserver
 */
public abstract class Observable<@NonNull T> implements ObservableSource<T> {
     ...
     * </code></pre>
     * <p>
     * Whenever an {@link java.util.Observer} subscribes to the returned {@code Observable}, the provided
    ...
    /**
     * Returns an {@code Observable} that calls an {@link ObservableSource} factory to create an {@code ObservableSource} for each new {@link java.util.Observer}
    ...
    /**
     * Returns an {@code Observable} that emits no items to the {@link java.util.Observer} and immediately invokes its
     * {@link java.util.Observer#onComplete onComplete} method.
     * <p>
    ...
    /**
     * Returns an {@code Observable} that invokes an {@link java.util.Observer}'s {@link java.util.Observer#onError onError} method when the
     ...
     *
     * @param throwable
     *            the particular {@link Throwable} to pass to {@link java.util.Observer#onError onError}
     * @param <T>
     *            the type of the items (ostensibly) emitted by the {@code Observable}
     * @return the new {@code Observable} instance
    ...
    /**
     * Returns an {@code Observable} instance that runs the given {@link Action} for each {@link java.util.Observer} and
     ...
     *  delivered to the downstream via {@link java.util.Observer#onError(Throwable)},
     *  except when the downstream has canceled the resulting {@code Observable} source.
     *  In this latter case, the {@code Throwable} is delivered to the global error handler via
     *  {@link RxJavaPlugins#onError(Throwable)} as an {@link com.liang.rxjava3.exceptions.UndeliverableException UndeliverableException}.
     *  </dd>
     * </dl>
    ...
    /**
     * Returns an {@code Observable} instance that runs the given {@link Runnable} for each {@link java.util.Observer} and
     ...
     * @param generator the {@link Consumer} called in a loop after a downstream {@link java.util.Observer} has
     ...
     * </dl>
     *
     * @param <S> the type of the per-{@link java.util.Observer} state
     * @param <T> the generated value type
     ...
     * to generate a single item on demand (when {@link java.util.Observer}s subscribe to it).
     * <p>
    ...
    /**
     * Flattens an {@link Iterable} of {@link ObservableSource}s into one {@code Observable}, in a way that allows an {@link java.util.Observer} to receive all
     ...
     * error via {@link java.util.Observer#onError onError}, {@code mergeDelayError} will refrain from propagating that
    ...
    /**
     * Flattens an array of {@link ObservableSource}s into one {@code Observable}, in a way that allows an {@link java.util.Observer} to receive all
    ...
    /**
     * Flattens an {@link ObservableSource} that emits {@code ObservableSource}s into one {@code Observable}, in a way that allows an {@link java.util.Observer} to
    ...
    /**
     * Flattens two {@link ObservableSource}s into one {@code Observable}, in a way that allows an {@link java.util.Observer} to receive all
     * successfully emitted items from each of the {@code ObservableSource}s without being interrupted by an error
     * notification from one of them.
     * <p>
     * This behaves like {@link #merge(ObservableSource, ObservableSource)} except that if any of the merged {@code ObservableSource}s
     * notify of an error via {@link java.util.Observer#onError onError}, {@code mergeDelayError} will refrain from
    ...
    /**
     * Flattens three {@link ObservableSource}s into one {@code Observable}, in a way that allows an {@link java.util.Observer} to receive all
     ...
     * {@code ObservableSource}s notify of an error via {@link java.util.Observer#onError onError}, {@code mergeDelayError} will refrain
    ...
    /**
     * Flattens four {@link ObservableSource}s into one {@code Observable}, in a way that allows an {@link java.util.Observer} to receive all
     * successfully emitted items from all of the {@code ObservableSource}s without being interrupted by an error
     * notification from one of them.
     * <p>
     * This behaves like {@link #merge(ObservableSource, ObservableSource, ObservableSource, ObservableSource)} except that if any of
     * the merged {@code ObservableSource}s notify of an error via {@link java.util.Observer#onError onError}, {@code mergeDelayError}
    ...
    /**
     * Returns an {@code Observable} that never sends any items or notifications to an {@link java.util.Observer}.
     * <p>
     ...
     * <p>
     * The resulting {@code Observable<R>} returned from {@code zip} will invoke {@link java.util.Observer#onNext onNext}
     ...
     * <p>
     * In Rx.Net this is the {@code any} {@link java.util.Observer} but we renamed it in RxJava to better match Java naming
     * idioms.
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
    ...
    /**
     * Subscribes to the source and calls the {@link java.util.Observer} methods <strong>on the current thread</strong>.
     * <p>
     * Note that calling this method will block the caller thread until the upstream terminates
     * normally, with an error or the {@code Observer} disposes the {@link Disposable} it receives via
     * {@link java.util.Observer#onSubscribe(Disposable)}.
     ...
     */
    @SchedulerSupport(SchedulerSupport.NONE)
    public final void blockingSubscribe(@NonNull java.util.Observer<? super T> observer) {
     ...
     * subscribe/dispose behavior of all the {@link java.util.Observer}s.
     * <p>
     ...
     * into their respective {@link java.util.Observer} signal types.
     * <p>
     ...
     * <p>
     * By default, {@code distinct()} uses an internal {@link HashSet} per {@link java.util.Observer} to remember
     ...
     *            function called for each individual {@link java.util.Observer} to return a {@link Collection} subtype for holding the extracted
     ...
     * {@link java.util.Observer#onComplete onComplete} or {@link java.util.Observer#onError onError}.
     * <p>
    ...
    /**
     * Calls the appropriate {@code onXXX} consumer (shared between all {@link java.util.Observer}s) whenever a signal with the same type
     ...
     * {@code Observable} to its {@link java.util.Observer}s and to the given shared {@code Observer} instance.
     * <p>
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @NonNull
    public final Observable<T> doOnEach(@NonNull java.util.Observer<? super T> observer) {
        Objects.requireNonNull(observer, "observer is null");
        return doOnEach(
    ...
    /**
     * Calls the appropriate {@code onXXX} method (shared between all {@link java.util.Observer}s) for the lifecycle events of
     ...
     *
     * @param onSubscribe
     *              a {@link Consumer} called with the {@link Disposable} sent via {@link java.util.Observer#onSubscribe(Disposable)}
     * @param onDispose
     ...
     * its {@link java.util.Observer}s. Each subscription will result in an invocation of the given action except when the
     ...
     * <p>
     * Each emitted {@code GroupedObservable} allows only a single {@link java.util.Observer} to subscribe to it during its
     ...
     * <p>
     * Allows hiding extra features such as {@link com.liang.rxjava3.subjects.Subject}'s
     * {@link java.util.Observer} methods or preventing certain identity-based
     ...
     * <p>
     * In Rx.Net this is negated as the {@code any} {@link java.util.Observer} but we renamed this in RxJava to better match Java
     * naming idioms.
     * <p>
     ...
     * Returns an {@code Observable} which, when subscribed to, invokes the {@link ObservableOperator#apply(java.util.Observer) apply(Observer)} method
     * of the provided {@link ObservableOperator} for each individual downstream {@link java.util.Observer} and allows the
     ...
     *
     * @param scheduler
     *            the {@code Scheduler} to notify {@link java.util.Observer}s on
     * @return the new {@code Observable} instance
     ...
     * its {@link java.util.Observer}, the {@code ObservableSource} invokes its {@code Observer}'s {@code onError} method, and then quits
     ...
     * {@code resumeFunction}, which will invoke the {@code Observer}'s {@link java.util.Observer#onNext onNext} method if it is
     ...
     * will invoke the {@code Observer}'s {@link java.util.Observer#onNext onNext} method if it is able to do so. In such a case,
    ...
    /**
     * Nulls out references to the upstream producer and downstream {@link java.util.Observer} if
     ...
     * {@link java.util.Observer}s that have subscribed to it.
     * <p>
     ...
     *            causing multiple subscriptions to the source sequence. {@link java.util.Observer}s to the given source will
     ...
     * @param <R> the accumulator and output value type
     * @param seedSupplier
     *            the {@link Supplier} that provides the initial (seed) accumulator value for each individual {@link java.util.Observer}
     * @param reducer
     *            an accumulator function to be invoked on each item emitted by the current {@code Observable}, the
     *            result of which will be used in the next accumulator call
     * @return the new {@code Single} instance
     ...
     * that will replay all of its items and notifications to any future {@link java.util.Observer}. A connectable
     ...
     * <p>
     * If the current {@code Observable} calls {@link java.util.Observer#onError}, this method will resubscribe to the current
    ...
    /**
     * Subscribes to the current {@code Observable} and wraps the given {@link java.util.Observer} into a {@link SafeObserver}
     ...
     */
    @SchedulerSupport(SchedulerSupport.NONE)
    public final void safeSubscribe(@NonNull java.util.Observer<? super T> observer) {
        Objects.requireNonNull(observer, "observer is null");
     ...
     * @param accumulator
     *            an accumulator function to be invoked on each item emitted by the current {@code Observable}, whose
     *            result will be emitted to {@link java.util.Observer}s via {@link java.util.Observer#onNext onNext} and used in the
     ...
     * @param <R> the initial, accumulator and result type
     * @param seedSupplier
     *            a {@link Supplier} that returns the initial (seed) accumulator item for each individual {@link java.util.Observer}
     * @param accumulator
     *            an accumulator function to be invoked on each item emitted by the current {@code Observable}, whose
     *            result will be emitted to {@code Observer}s via {@link java.util.Observer#onNext onNext} and used in the
     *            next accumulator call
     * @return the new {@code Observable} instance
     ...
     * <p>
     * It is possible for an {@code Observable} to invoke its {@link java.util.Observer}s' methods asynchronously, perhaps from
     ...
     * there is at least one {@link java.util.Observer}, the current {@code Observable} will stay subscribed and keep emitting signals.
     ...
     * <p>
     * This {@link java.util.Observer} accumulates a queue long enough to store the first {@code count} items. As more items are
    ...
    /**
     * Wraps the given onXXX callbacks into a {@link Disposable} {@link java.util.Observer},
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @Override
    public final void subscribe(@NonNull java.util.Observer<? super T> observer) {
        Objects.requireNonNull(observer, "observer is null");
        try {
     ...
     * performs the necessary business logic and handles the incoming {@link java.util.Observer}s.
     ...
     * applied by {@link #subscribe(java.util.Observer)} before this method gets called.
     * @param observer the incoming {@code Observer}, never {@code null}
     */
    protected abstract void subscribeActual(@NonNull java.util.Observer<? super T> observer);

    /**
     * Subscribes a given {@link java.util.Observer} (subclass) to the current {@code Observable} and returns the given
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @NonNull
    public final <@NonNull E extends java.util.Observer<? super T>> E subscribeWith(E observer) {
        subscribe(observer);
        return observer;
    }

    /**
     * Asynchronously subscribes {@link java.util.Observer}s to the current {@code Observable} on the specified {@link Scheduler}.
     * <p>
     ...
     * <p>
     * This method returns an {@code Observable} that will invoke a subscribing {@link java.util.Observer}'s
     * {@link java.util.Observer#onNext onNext} function a maximum of {@code count} times before invoking
     * {@link java.util.Observer#onComplete onComplete}.
     * <p>
     ...
     * <p>
     * Normally, an {@link ObservableSource} that returns multiple items will do so by invoking its {@link java.util.Observer}'s
     * {@link java.util.Observer#onNext onNext} method for each such item. You can change this behavior by having the
