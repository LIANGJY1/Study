 ...
 * exception into the global error handler via {@link com.liang.rxjava3.plugins.RxJavaPlugins#onError(Throwable)}.
 * <p>
 ...
 * is a need for handling multiple resources, one can create a {@link com.liang.rxjava3.disposables.CompositeDisposable}
...
public interface MaybeEmitter<@NonNull T> {
     ...
     * <p>
     * Unlike {@link #onError(Throwable)}, the {@link com.liang.rxjava3.plugins.RxJavaPlugins#onError(Throwable) RxjavaPlugins.onError}
